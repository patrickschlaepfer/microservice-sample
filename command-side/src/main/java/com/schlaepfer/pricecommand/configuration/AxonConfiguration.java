package com.schlaepfer.pricecommand.configuration;
...
import com.schlaepfer.pricecommand.aggregates.PriceAggregate;
...
/*    @Bean
    ...
    @Bean
	EventSourcingRepository<PriceAggregate> priceEventSourcingRepository() {
        EventSourcingRepository<PriceAggregate> repo = new EventSourcingRepository<PriceAggregate>(PriceAggregate.class, eventStore());
